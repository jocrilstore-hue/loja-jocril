...
const PLP_PRODS: ProductMock[] = [
  ...
  { sku: 'EXP-A4-04P',   name: 'Expositor A4 · 4 prateleiras',      cat: 'Acrílicos Chão', material: 'Acrílico 5mm',       from: 32.80,  tiers: '1+ · 10+ · 100+', img: '/assets/portfolio/carm.avif',         stock: 'in'   },
  { sku: 'EXP-PARED-A5', name: 'Expositor parede 6 bolsas A5',      cat: 'Acrílicos Chão', material: 'Acrílico 3mm',       from: 54.00,  tiers: '1+ · 10+',         img: '/assets/portfolio/ricola.avif',       stock: 'in'   },
  ...
  { sku: 'EXP-CHAO-7N',  name: 'Expositor chão 7 níveis',           cat: 'Acrílicos Chão', material: 'Acrílico 6mm',       from: 245.00, tiers: '1+',                img: '/assets/portfolio/beefeater.avif',    stock: 'low'  },
  { sku: 'DSP-PAR-LUZ',  name: 'Display parede com iluminação',     cat: 'Acrílicos Chão', material: 'Acrílico 5mm + LED', from: 128.00, tiers: '1+ · 5+',           img: '/assets/portfolio/rayban.avif',       stock: 'in'   },
  { sku: 'EXP-HOR-12B',  name: 'Expositor horizontal 12 bolsas',    cat: 'Acrílicos Chão', material: 'Acrílico 3mm',       from: 68.00,  tiers: '1+ · 10+',          img: '/assets/portfolio/bioderma.avif',     stock: 'in'   },
  { sku: 'EXP-CILIND',   name: 'Expositor cilíndrico ø300',         cat: 'Acrílicos Chão', material: 'Acrílico 5mm',       from: 95.00,  tiers: '1+ · 5+',           img: '/assets/portfolio/glade.avif',        stock: 'in'   },
  { sku: 'EXP-MODULAR',  name: 'Expositor modular personalizável',  cat: 'Acrílicos Chão', material: 'Acrílico 6mm',       from: 220.00, tiers: '1+',                img: '/assets/portfolio/loreal.avif',       stock: 'made' },
];
      ...
      >
        <div style={{ maxWidth: 1400, margin: '0 auto' }}>
          <div className="text-mono-xs" style={{ color: 'var(--color-base-500)', display: 'flex', gap: 8, marginBottom: 24 }}>
            ...
            <span>/</span>
            <span style={{ color: 'var(--color-light-base-primary)' }}>Acrílicos Chão</span>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 48, alignItems: 'end' }}>
            <div>
              ...
              <h1 className="heading-1" style={{ margin: '16px 0 0 0', color: 'var(--color-light-base-primary)' }}>
                Acrílicos<br /><span style={{ color: 'var(--color-accent-100)' }}>de chão</span>
              </h1>
            </div>
            <div>
              <p className="text-mono-md" style={{ color: 'var(--color-base-300)', margin: 0, maxWidth: '50ch' }}>
                Expositores de chão em acrílico 5–6mm. Para retalho, cosmética e ponto de venda. Corte laser + colagem estrutural, produção em série.
              </p>
      ...
      >
        <div style={{ maxWidth: 1400, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
          ...
          <span className="text-mono-xs" style={{ color: 'var(--color-base-600)', marginLeft: 'auto' }}>
            {PLP_PRODS.length} de 32 produtos
          </span>
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', display: 'grid', gridTemplateColumns: '260px 1fr', gap: 32 }}>
          ...
          <div>
            <div style={{ display: 'grid', gridTemplateColumns: `repeat(${cols}, 1fr)`, gap: 16 }}>
              {PLP_PRODS.map((p) => <ProductCard key={p.sku} p={p} />)}
            </div>
            <Pagination />
          </div>
        </div>
