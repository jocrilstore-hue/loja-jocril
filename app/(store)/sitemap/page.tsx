...
const GROUPS: { kicker: string; title: string; items: [string, string][] }[] = [
  { kicker: '01', title: 'Storefront · Core', items: [
    ...
    ['Ficha de produto (PDP)', '/produtos/expositor-a3'],
  ...
  { kicker: '04', title: 'Legal', items: [
    ...
    ['Política de Envios',       '/politica-envios'],
    ['Política de Devoluções',   '/politica-devolucoes'],
  ...
  { kicker: '06', title: 'Admin (B2B internal)', items: [
    ...
    ['Editor de variante',           '/admin/produtos/variante'],
    ['Escalões de preço',            '/admin/escaloes'],
