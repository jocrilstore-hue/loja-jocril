...
## Port philosophy — faithful 1:1 from the Claude Design bundle
...
Portuguese URLs throughout. See plan §4.1 at `C:\Users\maria\.claude\plans\write-down-a-plan-quiet-ember.md` for the full route map.
...
`C:\Users\maria\.claude\plans\write-down-a-plan-quiet-ember.md`
...
- Run destructive git (reset --hard, force push, clean -f) — the global `CLAUDE.local.md` blocks these.
